...
public class MailClient extends Frame 
{
  ...
  private Button btSend = new Button("Send"); private Button btClear = new Button("Clear"); 
  ...
  /**
   * Create a new MailClient window with fields for entering all * the relevant information (From, To, Subject, and message). */
  public MailClient() { super("Java Mailclient");
  ...
  class SendListener implements ActionListener 
  {
    ...
    { 
      ...
      {
        /* If there is an error, do not go further */ return;
      }
      /*try 
      {
